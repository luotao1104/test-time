    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white">
      ...
      <header className="pt-16 pb-8 text-center">
        ...
        >
          ...
          <p className="text-xl text-gray-300">你的专注与创造力工作站</p>
        </motion.div>
      </header>
              ...
              <Link key={module.id} to={module.path}>
                ...
                >
                  ...
                  <div className="relative bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20 hover:border-white/40 transition-all duration-300">
                    <div className={`w-16 h-16 rounded-xl bg-gradient-to-br ${module.color} flex items-center justify-center mb-4`}>
